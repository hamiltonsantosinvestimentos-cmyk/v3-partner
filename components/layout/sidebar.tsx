...
const NAV_SECTIONS: NavSection[] = [
  {
    label: "GERAL",
    items: [
      { href: "/dashboard", label: "Dashboard", icon: "LayoutDashboard", roles: ["ADMIN", "STARTER", "PARTNER", "PARTNER_PRO", "PARTNER_HE", "ENTERPRISE", "MESA_OPERACIONAL", "GESTAO", "SDR", "CLOSER"] },
      { href: "/crm", label: "CRM", icon: "ContactRound", roles: ["ADMIN", "STARTER", "PARTNER", "PARTNER_PRO", "PARTNER_HE", "ENTERPRISE"] },
    ...
    items: [
      {
        ...
        roles: ["ADMIN", "GESTAO", "STARTER", "PARTNER", "PARTNER_PRO", "PARTNER_HE", "ENTERPRISE", "MESA_OPERACIONAL"],
        children: [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/comissoes", label: "Comissões", icon: "Wallet", roles: ["ADMIN", "STARTER", "PARTNER", "PARTNER_PRO", "PARTNER_HE", "ENTERPRISE", "FINANCEIRO"] },
      { href: "/minha-assinatura", label: "Minha Assinatura", icon: "BadgeCheck", roles: ["STARTER", "PARTNER", "PARTNER_PRO", "PARTNER_HE", "ENTERPRISE"] },
      {
