          ...
          const narRes = await fetch("/api/ma/forja-narrative", {
            ...
            body: JSON.stringify({
              deal: {
                ...
                tipo_operacao_v3:   ((deal as Record<string,unknown>).asset_data as Record<string,unknown> | undefined)?.tipo_operacao_v3,
                tem_pendencias:     (((deal as Record<string,unknown>).asset_data as Record<string,unknown> | undefined)?.juridico as Record<string,unknown> | undefined)?.tem_pendencias,
                referencia_mercado: ((deal as Record<string,unknown>).asset_data as Record<string,unknown> | undefined)?.referencia_mercado,
              },
