            ...
            if (detailTab === "forja") {
              ...
              return (
                <div className="mt-2 space-y-4">
                  ...
                  />
                  {/* 06/09/2026 (BRIEF Link de Captacao pos-NCNDA): bloco "Link de
                      Upload Externo" que vivia aqui, solto e sem trava por assinatura,
                      foi movido para a aba "NDA / Mandato" (contrato-panel.tsx), só
                      aparecendo com o NCNDA assinado. Ver session-decisions.md 06/09/2026. */}
