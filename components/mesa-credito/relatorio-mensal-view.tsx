...
// todo dia 1. Partner vê só o dele; Mesa/Gestão/Admin veem a rede inteira. Usado em
// /mesa-credito/relatorio-mensal e /mesa-operacional/relatorio-mensal (só equipe).
export async function RelatorioMensalView({ mes, basePath, somenteEquipe = false }: { mes?: string; basePath: string; somenteEquipe?: boolean }) {
  ...
  if (!user || (!equipe && (!partner || somenteEquipe))) {
    return (
