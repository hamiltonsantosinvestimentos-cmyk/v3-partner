// Checklists de documentos por linha de crédito e tipo de cliente.
// Extraído aqui para uso tanto no frontend quanto em rotas de servidor (OCR batch).
...
export const CHECKLISTS: Record<string, Record<"PF" | "PJ", ChecklistItem[]>> = {
  "Home Equity": {
    PF: [
  ...
  "CRI Cash Collateral": {
    PF: [
      ...
      { id: "cri_pf_6", label: "3 fotos internas do imóvel", required: true },
      { id: "cri_pf_7", label: "3 fotos externas do imóvel", required: true },
    ],
    PJ: [
      ...
      { id: "cri_pj_8", label: "3 fotos internas do imóvel", required: true },
      { id: "cri_pj_9", label: "3 fotos externas do imóvel", required: true },
    ],
  },
  "CRA": {
    PF: [
  ...
  "Fundo Construção — Moradia": {
    PF: [
      ...
      { id: "fcr_pf_10", label: "3 fotos internas do imóvel / obra", required: true },
      { id: "fcr_pf_11", label: "3 fotos externas do imóvel / obra", required: true },
    ],
    PJ: [
      ...
      { id: "fcr_pj_11", label: "3 fotos internas do imóvel / obra", required: true },
      { id: "fcr_pj_12", label: "3 fotos externas do imóvel / obra", required: true },
    ],
  },
  "HomeCash": {
    PF: [
      ...
      { id: "hc_pf_10", label: "3 fotos internas do imóvel", required: true },
      { id: "hc_pf_11", label: "3 fotos externas do imóvel", required: true },
    ],
    PJ: [
      ...
      { id: "hc_pj_10", label: "3 fotos internas do imóvel", required: true },
      { id: "hc_pj_11", label: "3 fotos externas do imóvel", required: true },
    ],
  },
  "Giro Auto": {
    PF: [
  ...
  "CGI — Grandes Empresas": {
    PF: [
      ...
      { id: "cgi_pf_8", label: "3 fotos internas do imóvel em garantia", required: true },
      { id: "cgi_pf_9", label: "3 fotos externas do imóvel em garantia", required: true },
    ],
    PJ: [
      ...
      { id: "cgi_pj_10", label: "3 fotos internas do imóvel em garantia", required: true },
      { id: "cgi_pj_11", label: "3 fotos externas do imóvel em garantia", required: true },
    ],
  },
  "CPR Agro": {
    PF: [
...
export const DEFAULT_CHECKLIST: Record<"PF" | "PJ", ChecklistItem[]> = {
  PF: [
...
/** Retorna o label esperado para um doc_id, dado credit_line e client_type. */
export function getDocLabel(docId: string, creditLine: string, clientType: "PF" | "PJ"): string | null {
  const list = CHECKLISTS[creditLine]?.[clientType] ?? DEFAULT_CHECKLIST[clientType];
  return list.find((d) => d.id === docId)?.label ?? null;
}
