...
// PATCH — retoma um add-on pausado (não usar em cancelado — use /ativar de novo).
export async function PATCH(_req: NextRequest, { params }: { params: Promise<{ partnerId: string }> }) {
  ...
  await db.from("notifications").insert({
    user_id: partnerId,
    title: "Atendimento IA no WhatsApp reativado",
    message: "Seu add-on voltou a funcionar normalmente.",
    type: "SDR_ADDON_RETOMADO",
