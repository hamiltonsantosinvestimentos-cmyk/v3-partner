...
import { Testemunha2Client } from "./testemunha2-client";
...
export default async function Testemunha2Page({
  params,
}: {
  ...
  return <Testemunha2Client token={token} contrato={contrato as Parameters<typeof Testemunha2Client>[0]["contrato"]} />;
}
