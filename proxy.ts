...
const PUBLIC_ROUTES = ["/login", "/esqueci-senha", "/auth/callback", "/auth/update-password", "/unauthorized", "/politica-privacidade", "/api/demo-login", "/api/auth/login", "/c/", "/api/captacao/", "/mf/", "/api/ma-captacao/", "/api/migrate-ma-captacao", "/assinar/", "/api/contratos/", "/api/cpf-validate", "/cadastro-partner", "/api/cadastro-partner", "/api/setup/check", "/status-cadastro", "/api/cadastro-partner/status", "/p/", "/vdr/", "/api/investor/", "/api/ma/preview-criativo", "/api/ma/cim-pdf", "/api/ma/meetings/ingest", "/api/sdr/webhook", "/api/sdr/instagram-webhook", "/api/sdr/messenger-webhook", "/api/sdr/telegram-webhook", "/api/partner/sdr/telegram-webhook/", "/api/partner/sdr/meta-oauth/callback", "/api/calendly/webhook", "/upload/", "/api/public/upload/", "/api/ma/upload-notify", "/api/cron/", "/manifest.json", "/sw.js", "/api/ma/investor-demands", "/api/ma/clicksign-webhook", "/api/webhooks/certone", "/intake/", "/api/ma/bp-intake/", "/aceite-tec/", "/api/propostas/mandato-tec/accept/", "/api/cm/intake/", "/api/cm/deal-room/", "/vdr/cm/", "/api/guardian/run", "/api/relatorios/ingest", "/checkout/", "/api/checkout/", "/api/cora/webhook", "/intake/credit/", "/api/credit-engine/intake/", "/api/cm/annex-sign/", "/bolsa/imoveis", "/api/public/bolsa/imoveis", "/api/public/stats-captacao", "/documentos/", "/api/public/credit-upload/", "/acompanhar/", "/preencher-intermediarios/", "/api/cm/deal-intermediaries/fill/", "/relatorio-credito/", "/aceite/", "/api/public/governance-signoff/", "/analise", "/analise-v2", "/api/cm/qualificacao/", "/api/contracts/html/", "/api/cm/kyc/check", "/seja-partner", "/simulador-home-equity-v3", "/api/public/partner-quiz", "/api/public/home-equity-lead", "/api/public/partner-card", "/api/public/white-label", "/api/public/quiz-progress", "/api/analise/"];
...
// Nota (08/09/2026): "/api/webhooks/certone" é o webhook da CertOne (Fase 2
// do BRIEF ClickSign vs CertOne), mesmo motivo do clicksign-webhook acima
// -- POST vem de fora, sem sessao Supabase nenhuma. A rota se protege
// sozinha com um token estatico (CERTONE_WEBHOOK_TOKEN, fail-closed sem
// ele configurado), ver app/api/webhooks/certone/route.ts.
// Nota (14/09/2026): "/api/analise/" cobre POST /api/analise/track-open,
// chamada pelo client de /analise-v2 (visitante anônimo, sem sessão) --
// achado real ao testar em produção: sem este bypass a rota levava 307 pro
// /login, o fetch (fire-and-forget, .catch silencioso) nunca dava erro
// visível, mas o rastreio de abertura nunca funcionava. Mesmo padrão de
// bug já visto no webhook da Cora (01/07/2026) e no relatório do Credit
// Engine (03/08/2026).
